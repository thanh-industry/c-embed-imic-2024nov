...
void busRegisterSetup(void) {
	...
	registerBitSet(REG_RCC_AHB1ENR, (BIT_0 | BIT_3 | BIT_7)); 			// For using general purpose I/O function PORT A, D, H
	...
	registerBitSet(REG_RCC_APB2ENR, BIT_0); 							// For using advanced timer 1
